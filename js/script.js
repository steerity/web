...
$(document).ready(function() {
    ...
    $('#mc-form').ajaxChimp({
        ...
        url: "//steerity.us14.list-manage.com/subscribe/post?u=96c5455acddb0ca513289e774&amp;id=d9c21f4a02"
        //url: "//steerity.us14.list-manage.com/subscribe?u=96c5455acddb0ca513289e774&id=d9c21f4a02"
    });
        ...
        if (name && emaild && message) {
            $.ajax({
                ...
                success: function(data) {
                    $(".Sucess").show();
                    $(".Sucess").fadeIn(2000);
                    $(".Sucess").html("<i class='fa fa-check'></i> Cher <b>" + name + "</b> Merci de votre solicitation, nous allons vous répondre dans les plus bref délais.");
                    $("#Name").val("");
                    $("#Email").val("");
                    $("#Subject").val("");
                    $("#Message").val("");
